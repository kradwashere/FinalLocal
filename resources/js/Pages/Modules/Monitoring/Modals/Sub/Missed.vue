<template>
    <b-modal v-model="showModal" title="Missed Enrollment" :hide-footer="true" style="--vz-modal-width: 700px;" header-class="p-3 bg-light" class="v-modal-custom" modal-class="zoomIn" centered>    
