...
export default {
    ...
    watch:{
         "semester.school"(newVal){
            this.semesters = this.dropdowns.filter(x => x.classification == newVal.term);
        }
    },
    methods : {
        show(id) {
        ...
        create(){
            this.form = this.$inertia.form({
                school_id: this.semester.school.id,
